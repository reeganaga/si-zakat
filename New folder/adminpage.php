...
<body>
    ...
    <section class="call-action section-padding color-green">
        <div class="container">
          ...
          <div class="col-4 padding-tb">
              <div class="call-action-but" style="text-align:center;"><a href="adminedit.php">EDIT ADMIN</a></div>
          </div>
        </div>
    </section>
	<section class="call-action section-padding color-blue">
        <div class="container">
          ...
          <div class="col-4 padding-tb">
              <div class="call-action-but" style="text-align:center;"><a href="donasi.php">Lihat Berita</a></div>
			  <div class="call-action-but" style="text-align:center;"><a href="beritatambah.php">Tambah Berita</a></div>
          </div>
        </div>
    </section>
    <section class="call-action section-padding color-green">
        <div class="container">
          <div class="col-8">
              <div class="call-title">Buku</div>
          </div>
          <div class="col-4 padding-tb">
              <div class="call-action-but" style="text-align:center;"><a href="donasi.php">Lihat Buku</a></div>
			  <div class="call-action-but" style="text-align:center;"><a href="donasi.php">Tambah Buku</a></div>
          </div>
        </div>
    </section>
	<section class="call-action section-padding color-blue">
        <div class="container">
          ...
          <div class="col-4 padding-tb">
              <div class="call-action-but" style="text-align:center;"><a href="donasi.php">ID Donatur</a></div>
			  <div class="call-action-but" style="text-align:center;"><a href="donasi.php">Lihat Donasi</a></div>
          </div>
        </div>
    </section>
